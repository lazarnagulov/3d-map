...
Camera2D::Camera2D(const glm::vec2& position /*= { 0 , 0 }*/, float zoom /*= 1.0f*/)
...
glm::mat4 Camera2D::GetProjectionMatrix(int screenWidth, int screenHeight) const {
...
glm::vec2 Camera2D::ScreenToWorld(float x, float y, int screenWidth, int screenHeight) const {
...
glm::vec2 Camera2D::WorldToScreen(const glm::vec2& p, int screenWidth, int screenHeight) const {
